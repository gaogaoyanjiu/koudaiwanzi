 ...
 */
@ContentView(R.layout.fragment_order_pay)
public class PayFragment extends BaseFragment {
    ...
    @ViewInject(R.id.listView_order_pay)
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //上拉加载和下拉刷新的监听
        ((PullToRefreshLayout) getActivity().findViewById(R.id.refresh_order_pay))
