 ...
 */
@ContentView(R.layout.fragment_shopping_car)
public class ShopCarFragment extends BaseFragment {
    ...
    //绑定listView
    @ViewInject(R.id.shopping_car_listview)
...
//    private RelativeLayout rl_safe;
        ...
        public void run() {
            ...
            x.http().get(params, new Callback.CommonCallback<String>() {
                ...
                public void onSuccess(String s) {
                    ...
                    adapter = new ShopCarAdapter(getActivity(), bean.getSHOPITEM(), handler);
                    ...
                    gridViewAdapter = new ShopCarGridViewAdapter(getActivity(), bean.getLIKEITEMS(), R.layout.item_shop_car_gridview);
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        mHandler = new Handler();
         View view_foot = LayoutInflater.from(getActivity()).inflate(R.layout.foot_shop, null);
        gridView = (GridView) view_foot.findViewById(R.id.gv_shop);
        listView.addFooterView(view_foot);
        SharedPreferences share = getActivity().getSharedPreferences("logIn", Context.MODE_PRIVATE);
        UID = share.getString("login", "");

        ck_all = (CheckBox) view.findViewById(R.id.shopping_car_checkbox);
        //点击编辑和完成按钮相互切换布局
...
//                                rl_safe.setVisibility(View.VISIBLE);
    ...
    private void couClick(View view) {
        ...
        String b = "0";
        if (b.equals(a)) {
            Toast.makeText(getActivity(), "请选择一件商品", Toast.LENGTH_SHORT).show();
        } else {
            String s1 = String.valueOf(a);
            String s2 = s1.substring(0, s1.indexOf("."));
            int i = Integer.parseInt(s2);
            Log.d("qucoudan", String.valueOf(i));
            Intent intent = new Intent(getActivity(), MergeActivity.class);
    ...
    private void deleteClick(View view) {
        if (ck_delete.isChecked()) {
            ...
            Toast.makeText(getActivity(), "请点击全选", Toast.LENGTH_SHORT).show();
        }
    }
}
