 ...
 */
@ContentView(R.layout.fragment_order_send)
public class SendFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //上拉加载和下拉刷新的监听
        ((PullToRefreshLayout) getActivity().findViewById(R.id.refresh_order_send))
                .setOnRefreshListener(new MyListener());

        orderAllAdapter = new OrderAllAdapter(getActivity());
