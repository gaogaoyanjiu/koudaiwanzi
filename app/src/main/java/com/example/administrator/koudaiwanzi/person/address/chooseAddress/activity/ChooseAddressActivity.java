...
public class ChooseAddressActivity extends BaseActivity implements OnClickListener, OnWheelChangedListener {
	...
	private void setUpData() {
		initProvinceDatas();
		mViewProvince.setViewAdapter(new ArrayWheelAdapter<String>(ChooseAddressActivity.this, mProvinceDatas));
	...
	private void showSelectedResult() {
		Toast.makeText(ChooseAddressActivity.this, "地址为:"+mCurrentProviceName+","+mCurrentCityName+","
