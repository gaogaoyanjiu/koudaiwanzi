...
import com.example.administrator.koudaiwanzi.meatball.VideoBean;
 ...
 */
public class ConcernPAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    //广播在这里好用吗
    ...
    public ConcernPAdapter(Context context) {
        this.context = context;

    }

    public void addData(List<ConcernPersonBean.StoryBean> data) {
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_TYPE_IMAGE.ordinal()){
            View view = LayoutInflater.from(context).inflate(R.layout.item_japan_video, parent, false);
...
//                x.image().bind(myViewHolder.iv_p1, url + data.get(position).getITEMS().get(0).getICOURL());
//                x.image().bind(myViewHolder.iv_p2, url + data.get(position).getITEMS().get(1).getICOURL());
//                x.image().bind(myViewHolder.iv_p3, url + data.get(position).getITEMS().get(2).getICOURL());
//                myViewHolder.tv_name1.setText(data.get(position).getITEMS().get(0).getTRADENAME());
//                myViewHolder.tv_name2.setText(data.get(position).getITEMS().get(1).getTRADENAME());
//                myViewHolder.tv_name3.setText(data.get(position).getITEMS().get(2).getTRADENAME());
//                myViewHolder.tv_one.setText(data.get(position).getITEMS().get(0).getPRICE() + "");
//                myViewHolder.tv_two.setText(data.get(position).getITEMS().get(1).getPRICE() + "");
//                myViewHolder.tv_three.setText(data.get(position).getITEMS().get(2).getPRICE() + "");
//                myViewHolder.tv_one1.setText(data.get(position).getITEMS().get(0).getBARGAIN() + "");
//                myViewHolder.tv_two1.setText(data.get(position).getITEMS().get(1).getBARGAIN() + "");
//                myViewHolder.tv_three1.setText(data.get(position).getITEMS().get(2).getBARGAIN() + "");
