...
public class TakeFragment extends BaseFragment {
    ...
    @ViewInject(R.id.listView_order_take)
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String url = url1 + url2 + UID+"/2";
        Log.d("shuitanzhenganqi", url);
        ...
        //上拉加载和下拉刷新的监听
        ((PullToRefreshLayout) getActivity().findViewById(R.id.refresh_order_take))
