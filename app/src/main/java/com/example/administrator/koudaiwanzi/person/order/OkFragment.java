 ...
 */
@ContentView(R.layout.fragment_order_ok)
public class OkFragment extends BaseFragment {
    ...
    @ViewInject(R.id.listView_order_ok)
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //上拉加载和下拉刷新的监听
        ((PullToRefreshLayout) getActivity().findViewById(R.id.refresh_order_ok))
