...
import cn.sharesdk.onekeyshare.themes.classic.*;
...
public class FriendAdapter extends PullToRequestListAdapter implements PlatformActionListener {
	...
	/** 好友列表的头部View */
	private cn.sharesdk.onekeyshare.themes.classic.PRTHeader llHeader;
	...
	public View getHeaderView() {
		if (llHeader == null) {
			llHeader = new cn.sharesdk.onekeyshare.themes.classic.PRTHeader(getContext());
		}
		return llHeader;
	}
	...
	public static class Following extends cn.sharesdk.onekeyshare.themes.classic.FriendAdapter.Following {
