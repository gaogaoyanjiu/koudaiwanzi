...
package cn.sharesdk.key.themes.classic.port;

import java.util.ArrayList;

import android.content.Context;
import cn.sharesdk.key.themes.classic.PlatformPage;
import cn.sharesdk.key.themes.classic.PlatformPageAdapter;
...
public class PlatformPageAdapterPort extends PlatformPageAdapter {
	...
	public PlatformPageAdapterPort(cn.sharesdk.key.themes.classic.PlatformPage page, ArrayList<Object> cells) {
		super(page, cells);
	}
