...
package cn.sharesdk.key.themes.classic;
...
import cn.sharesdk.key.CustomerLogo;
import cn.sharesdk.key.OnekeySharePage;
import cn.sharesdk.key.OnekeyShareThemeImpl;
import cn.sharesdk.key.themes.classic.*;
import cn.sharesdk.key.themes.classic.land.PlatformPageAdapterLand;
import cn.sharesdk.key.themes.classic.port.PlatformPageAdapterPort;
...
public abstract class PlatformPage extends OnekeySharePage {
	...
	protected ArrayList<Object> collectCells() {
		...
		ArrayList<cn.sharesdk.onekeyshare.CustomerLogo> customers = getCustomerLogos();
